                    ...
                    <div class="large-12 columns center" >
                        ...
                        <div class="row collapse ">
                            <div class="small-6 columns" id="lista_prod_wpisanych">
                                <?php
                                    if(isset($produktyPosilku)){
                                        foreach($produktyPosilku as $produkt){
                                           echo '
                                           <div id="produkt_'.$produkt['id_prod'].'_div">
                                           - '.$produkt_array[$produkt['id_prod']].': <span id="prod_ilosc_html_'.$produkt['id_prod'].'">'.$produkt['ilosc'].'</span> g, 
                                                <input type="hidden" value="'.$produkt['id_uzytk_prod'].'" name="edit_produkt[]"> 
                                                <input id="ilos_prod_'.$produkt['id_prod'].'" type="hidden" value="'.$produkt['ilosc'].'" name="edit_prod_ilosc_'.$produkt['id_uzytk_prod'].'"> 
                                           <a href="/kalkulator/uzytkownik/usunproduktposilek/'.$produkt['dzien'].'/'.$produkt['posilek'].'/'.$produkt['id_uzytk_prod'].'" >Usuń</a>  
                                           </br>
                                           </div>'; 
                                        }
                                    }
            ...
            $('#dodaj_produkt_posilek').on('click', function() {
                ...
                if(ilosc > 0){
                    ...
                    if ( $( "#produkt_"+id_prod+"_div" ).length ){
                        $("#ilos_prod_"+id_prod).val(ilosc);
                        $("#prod_ilosc_html_"+id_prod).html(ilosc);
                        
                    }
                    else{
                     $('#lista_prod_wpisanych').append('<div id="produkt_'+id_prod+'_div">- '+nazwa+': <span id="prod_ilosc_html_'+id_prod+'">'+ilosc+'</span> g, <input type="hidden" value="'+id_prod+'" name="produkt[]"> <input id="ilos_prod_'+id_prod+'" type="hidden" value="'+ilosc+'" name="prod_ilosc_'+id_prod+'"> <a class="usun_produkt" >Usuń</a>  </br></div>');
