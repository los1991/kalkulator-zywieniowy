...
<div class="produkt view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th ><span>Parametry produktu na : </span><input type='number' id='gramatura_ilosc' value='100' style="display: inline-block; width: 100px;">g/ml</th>
            <td></td>
        </tr>
        ...
        <tr>
           <th scope="row">Dodaj nowy parametr na 100g/100ml produktu:</th> 
           <td>
